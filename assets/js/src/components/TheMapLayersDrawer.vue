...
export default {
    ...
    computed: {
        ...
        WMTS_TYPENAME_CORONA: () => [...WMTS_TYPENAME_CORONA].sort((a, b) => a.title.localeCompare(b.title)),
        ...
        WFS_TYPENAME_SURVEY_AREAS: () => [...WFS_TYPENAME_SURVEY_AREAS].sort((a, b) => a.title.localeCompare(b.title)),
        WMTS_TYPENAME_SURVEY_TOPOS: () => [...WMTS_TYPENAME_SURVEY_TOPOS].sort((a, b) => a.title.localeCompare(b.title))
