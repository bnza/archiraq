...
const predicateRowsVisibility = {
    entryId: [QUERY_TYPENAME_VW_SITES_SURVEY, QUERY_TYPENAME_VW_SITES_RS, QUERY_TYPENAME_VW_SITES_SURVEY_NOT_SAMPLED],
    chronology: [QUERY_TYPENAME_VW_SITES_SURVEY, QUERY_TYPENAME_VW_SITES_SURVEY_NOT_SAMPLED],
    district: [QUERY_TYPENAME_VW_SITES_SURVEY, QUERY_TYPENAME_VW_SITES_RS, QUERY_TYPENAME_VW_SITES_SURVEY_NOT_SAMPLED],
    modernName: [QUERY_TYPENAME_VW_SITES_SURVEY, QUERY_TYPENAME_VW_SITES_RS, QUERY_TYPENAME_VW_SITES_SURVEY_NOT_SAMPLED],
    ancientName: [QUERY_TYPENAME_VW_SITES_SURVEY, QUERY_TYPENAME_VW_SITES_RS, QUERY_TYPENAME_VW_SITES_SURVEY_NOT_SAMPLED],
    nearestCity: [QUERY_TYPENAME_VW_SITES_SURVEY, QUERY_TYPENAME_VW_SITES_SURVEY_NOT_SAMPLED],
    survey: [QUERY_TYPENAME_VW_SITES_SURVEY, QUERY_TYPENAME_VW_SITES_SURVEY_NOT_SAMPLED],
    threats: [QUERY_TYPENAME_VW_SITES_SURVEY, QUERY_TYPENAME_VW_SITES_RS, QUERY_TYPENAME_VW_SITES_SURVEY_NOT_SAMPLED],
    features: [QUERY_TYPENAME_VW_SITES_SURVEY, QUERY_TYPENAME_VW_SITES_SURVEY_NOT_SAMPLED],
};
