...
ALTER TABLE "geom"."mat_site" OWNER TO "archiraq_admin";
...
ALTER FUNCTION "geom"."select_vw_site_by_index"("site_id" integer) OWNER TO "archiraq_admin";
...
ALTER FUNCTION "geom"."tf___delete_geom_mat_site"() OWNER TO "archiraq_admin";
...
ALTER FUNCTION "geom"."tf___insert_into_geom_mat_site"() OWNER TO "archiraq_admin";
...
ALTER FUNCTION "geom"."tf___update_geom_mat_site_child"() OWNER TO "archiraq_admin";
...
ALTER FUNCTION "geom"."update_mat_site_by_index"("new_site_id" integer, "old_site_id" integer) OWNER TO "archiraq_admin";
...
ALTER FUNCTION "public"."orientedenvelope"("g" "public"."geometry") OWNER TO "archiraq_admin";
...
ALTER TABLE "geom"."vw_site_rs_point" OWNER TO "archiraq_admin";
...
ALTER TABLE "geom"."vw_site_rs_poly" OWNER TO "archiraq_admin";
...
ALTER TABLE "geom"."vw_site_survey_point" OWNER TO "archiraq_admin";
...
ALTER TABLE "geom"."vw_site_survey_poly" OWNER TO "archiraq_admin";
