...
/**
 * Migration to update geom.vw_site_survey_poly and geom.vw_site_survey_point views
 * adding WHERE ms.survey_type != 'not_sampled'
 */
final class Version20260418114500 extends AbstractMigration
{
    public function getDescription() : string
    {
        return 'Update site survey views to exclude not_sampled survey types';
    }
