 ...
 */
final class Version20260418141639 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql("ALTER TABLE geom.vw_site_survey_poly OWNER TO archiraq_admin;");
        ...
        $this->addSql("ALTER TABLE geom.vw_site_survey_point OWNER TO archiraq_admin;");

        $this->addSql("CREATE OR REPLACE VIEW geom.vw_site_rs_poly
            (id, contribute_id, entry_id, sbah_no, cadastre, modern_name, nearest_city, ancient_name, district_id,
             district, governorate, nation, chronology, survey_type, surveys, survey_refs, features, features_remarks,
             threats, remote_sensing, survey_verified_on_field, excavations_whom_when, excavations_bibliography,
             remarks, e, n, area, length, width, geom)
            ...
            SELECT ms.id,
                   ...
                   ms.geom
            FROM geom.mat_site ms
            WHERE ms.remote_sensing = true AND ST_IsEmpty(geom)=false;");

        $this->addSql("ALTER TABLE geom.vw_site_rs_poly OWNER TO archiraq_admin;");

        $this->addSql("CREATE OR REPLACE VIEW geom.vw_site_rs_point
            (id, contribute_id, entry_id, sbah_no, cadastre, modern_name, nearest_city, ancient_name, district_id,
             district, governorate, nation, chronology, survey_type, surveys, survey_refs, features, features_remarks,
             threats, remote_sensing, survey_verified_on_field, excavations_whom_when, excavations_bibliography,
             remarks, e, n, area, length, width, geom)
        ...
        $this->addSql("ALTER TABLE geom.vw_site_rs_point OWNER TO archiraq_admin;");
 }
